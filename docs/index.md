# <picture><source srcset="images/archlette-stainedglassA-light.png"><img src="images/archlette-stainedglassA-light.png" alt="" height="28" width="28" align="absmiddle"></picture> Archlette
...
- [Security Guide](guide/security.md) — Input validation and security model

**Contributing:**

- [How to Contribute](CONTRIBUTING.md) — Development setup
- [Security Guide](guide/security.md) — Security architecture and best practices
